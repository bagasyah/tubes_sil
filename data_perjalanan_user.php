...
<body>
    ...
    <div class="container table-responsive">
        ...
        echo "<button class='btn btn-danger ml-1' type='reset' onclick='window.location.href=\"data_perjalanan_user.php?id=$user_id\"'><i class='fas fa-sync'></i></button>";
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>RP." . $biaya . "</td>";
                echo "<td><a href='edit.php?id=" . $row['id'] . "' class='btn btn-primary mt-1'><i class='fas fa-pencil-alt'></i></a> </td>";
                echo "<td><a href='delete.php?id=" . $row['id'] . "' class='btn btn-danger'><i class='fas fa-trash-alt'></i></span></a> </td>";
                echo "</div>";
                echo "</div>";
                echo "</div>";
            }
            ...
            if ($totalPages > 0) {
                ...
                if ($currentPage > 1) {
                    ...
                    echo "<li class='page-item'><a class='page-link' href='data_perjalanan_user.php?id=$user_id&page=$prevPage'>&laquo;</a></li>";
                }

                // Loop through the pagination numbers
                for ($page = 1; $page <= $totalPages; $page++) {
                    $activeClass = ($page == $currentPage) ? " active" : "";
                    echo "<li class='page-item$activeClass'><a class='page-link' href='data_perjalanan_user.php?id=$user_id&page=$page'>$page</a></li>";
                }

                // Add "Next" button for next page
                if ($currentPage < $totalPages) {
                    $nextPage = $currentPage + 1;
                    echo "<li class='page-item'><a class='page-link' href='data_perjalanan_user.php?id=$user_id&page=$nextPage'>&raquo;</a></li>";
                }
