...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto mr-3 mt-1">
                <li class="nav-item">
                    <a class="nav-link btn mb-1 mr-2 text-light btn-success" onclick="goBack()">
    ...
    <div class="container table-responsive">
        ...
        echo "<form method='GET' action='detail_akun.php?id=$user_id'>";
        ...
        echo "<button class='btn btn-danger ml-1' type='reset' onclick='window.location.href=\"detail_akun.php?id=$user_id\"'><i class='fas fa-sync'></i></button>";
        ...
        if ($result->num_rows > 0) {
            ...
            if ($totalPages > 0) {
                ...
                if ($currentPage > 1) {
                    ...
                    echo "<li class='page-item'><a class='page-link' href='detail_akun.php?id=$user_id&page=$prevPage'>&laquo;</a></li>";
                }

                // Loop through the pagination numbers
                for ($page = 1; $page <= $totalPages; $page++) {
                    $activeClass = ($page == $currentPage) ? " active" : "";
                    echo "<li class='page-item$activeClass'><a class='page-link' href='detail_akun.php?id=$user_id&page=$page'>$page</a></li>";
                }

                // Add "Next" button for next page
                if ($currentPage < $totalPages) {
                    $nextPage = $currentPage + 1;
                    echo "<li class='page-item'><a class='page-link' href='detail_akun.php?id=$user_id&page=$nextPage'>&raquo;</a></li>";
                }
